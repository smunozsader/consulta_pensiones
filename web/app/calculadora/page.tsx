...
export default function CalculadoraPage() {
  ...
  const handleDownloadClick = (type: 'pdf' | 'csv') => {
    setDownloadType(type);
    setEmailGateOpen(true);
  };

  const handleEmailGateSuccess = (email: string) => {
    // TODO: Generar y descargar archivo (PDF o CSV)
    if (downloadType === 'pdf') {
      console.log('Descargando PDF para:', email);
      // TODO: Implementar generación PDF
    } else if (downloadType === 'csv') {
      console.log('Descargando CSV para:', email);
      // TODO: Implementar generación CSV
    }
  };
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <EmailGateModal
        ...
        title={downloadType === 'pdf' ? 'Descargar como PDF' : 'Descargar como Excel'}
        description={downloadType === 'pdf'
          ? 'Registra tu email para recibir tus cálculos en PDF. Así podrás consultarlo después.'
          : 'Registra tu email para descargar tus cálculos en formato Excel. Podrás hacer ajustes después.'}
        downloadLabel={downloadType === 'pdf' ? 'Descargar PDF' : 'Descargar Excel'}
      />
