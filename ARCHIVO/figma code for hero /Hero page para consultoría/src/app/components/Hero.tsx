        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#00CC66] hover:bg-[#00b359] text-white rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105">
                <Calculator className="w-5 h-5" />
                Usar Calculadora
              </button>

              <button className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#0066CC] hover:bg-[#0052a3] text-white rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl">
                <FileText className="w-5 h-5" />
                Obtén Guía
              </button>

              <button className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-transparent border-2 border-white hover:bg-white/10 text-white rounded-lg transition-all duration-200">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white rounded-xl shadow-xl p-6 max-w-xs">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xl text-gray-900">+98% exactitud</p>
                </div>
              </div>
            </div>
          </div>
